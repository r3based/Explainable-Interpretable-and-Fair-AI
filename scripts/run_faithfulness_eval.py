...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=str, default=str(ROOT / "artifacts" / "eval" / "faithfulness"))
...
def _counterfactual_heatmap(model: ViTWrapper, image_tensor: torch.Tensor, args: argparse.Namespace) -> object:
